    ...
    <style>
        * {
        ...
        #default-panel h2 {
            ...
            margin-bottom: 16px;
            color: #fff;
            background: linear-gradient(90deg, var(--cat-education-and-career), var(--cat-caregiving));
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        }

        #default-panel .default-section {
            margin-bottom: 16px;
            padding-bottom: 16px;
            border-bottom: 1px solid rgba(255, 255, 255, 0.1);
        }

        #default-panel .default-section:last-child {
            margin-bottom: 0;
            padding-bottom: 0;
            border-bottom: none;
        }
        ...
        @media (max-width: 768px) {
            ...
            .category-filter {
                ...
                pointer-events: auto;
                /* Allow horizontal scrolling on this element */
                touch-action: pan-x;
            }
            ...
            .burger-menu {
                ...
                left: 0;
                width: 52px;
                height: 68px; /* Match category bar: 44px button + 24px padding */
                background: rgba(15, 23, 42, 0.95);
                border: none;
                border-top: 1px solid rgba(255, 255, 255, 0.1);
            ...
            #mobile-info-panel .default-section {
                margin-bottom: 12px;
                padding-bottom: 12px;
                border-bottom: 1px solid rgba(255, 255, 255, 0.1);
            }

            #mobile-info-panel .default-section:last-child {
                margin-bottom: 0;
                padding-bottom: 0;
                border-bottom: none;
            }
            ...
            /* Hide category tooltip on mobile - it interferes with touch */
            .category-tooltip {
                display: none !important;
            }
            ...
            #container {
                pointer-events: auto;
                /* Shrink container to not overlap category bar */
